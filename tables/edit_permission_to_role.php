...
if (isset($_POST['update'])) {
    ...
    if ($conn->query($sql)) {
        header("Location: ../role_has_permission.php?success=Permission updated successfully");
        exit;
    } else {
...
<html lang="en">
<head>
    <title>Edit Permission to role</title>
...
<!-- Page Wrapper -->
 ...
 <h2 class="mb-4">Edit Role-Permission Mapping</h2>
        ...
        <form method="POST">
            ...
            <a href="../role_has_permission.php" class="btn btn-secondary">Back</a>
        </form>
</div>
                                            <!-- Footer -->
