...
if (isset($_POST['save'])) {
    ...
    $sql = "INSERT INTO countries (country_name, status, created_at) VALUES ('$country_name', '$status', NOW())";
    if ($conn->query($sql)) {
        header("Location: ../countries.php?success=Country added successfully");
        exit;
    } else {
...
<h2 class="mb-4">Add New Country</h2>
        <form method="POST">
            ...
            <a href="../countries.php" class="btn btn-secondary">Back</a>
        </form>
